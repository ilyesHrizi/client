...
public class GetVideoDetails {
    public String video_slide,video_type , video_thumb , video_url , video_description,video_name , video_category ;

    public GetVideoDetails(String video_slide, String video_type, String video_thumb, String video_url, String video_description, String video_name, String video_category) {
