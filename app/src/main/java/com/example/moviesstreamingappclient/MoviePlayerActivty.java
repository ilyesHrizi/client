...
import com.example.moviesstreamingappclient.Service.FloatingWidgetService;
...
public class MoviePlayerActivty extends AppCompatActivity {
    Uri videoUri ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setfullScreen();
        setContentView(R.layout.activity_movie_player_activty);
        hideactionBar();
        ...
        exo_floating_widget.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                exoPlayer.release();
                Intent serviceintent = new Intent(MoviePlayerActivty.this, FloatingWidgetService.class);
